"""This module contains data definitions for CRU DataLab client"""
...
import crudatalab.view_definitions as view_definition

class DataReader(object):
    """This class read data from CRU DataLab and transform it to pandas frame"""
