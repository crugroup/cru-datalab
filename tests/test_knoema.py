...
class TestKnoemaClient(unittest.TestCase):
    ...
    def test_getdata_singleseries_by_member_id(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company='c1', indicator='ind_a')
    ...
    def test_getdata_multiseries_by_member_id(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company='c1;c2', indicator='ind_m;ind_a')
    ...
    def test_getdata_multiseries_by_member_name(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company=company_names, indicator=indicator_names)
        self.assertEqual(data_frame.shape[0], 56)
        self.assertEqual(data_frame.shape[1], 4)
    ...
    def test_getdata_multiseries_by_member_id_range(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company='c1;c2', indicator='ind_a', timerange='2017-2019')
    ...
    def test_getdata_singleseries_difffrequencies_by_member_id(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company='c1', indicator='ind_multi')
    ...
    def test_getdata_multiseries_singlefrequency_by_member_id(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company='c2', indicator='ind_multi', frequency='M')
        self.assertEqual(data_frame.shape[1], 1)
    ...
    def test_getdata_multiseries_multifrequency_by_member_id(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company='c1;c2', indicator='ind_a;ind_multi', frequency='A;M')
    ...
    def test_getdata_multiseries_multifrequency_by_member_id_range(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company='c1;c2', indicator='ind_a;ind_multi', frequency='A;M', timerange='2017M1-2020M12')
        self.assertEqual(data_frame.shape[1], 6)
    ...
    def test_wrong_dimension(self):
        ...
        with self.assertRaises(ValueError) as context:
            crudatalab.get('IMFWEO2017Apr', indicator='LP;NGDP')
    ...
    def test_wrong_dimension_with_transform(self):
        ...
        with self.assertRaises(ValueError) as context:
            crudatalab.get('IMFWEO2017Apr', indicator='LP;NGDP', transform='PCH')
    ...
    def test_empty_dimension_selection(self):
        ...
        with self.assertRaises(ValueError) as context:
            crudatalab.get('IMFWEO2017Apr', country='', subject='LP;NGDP')
    ...
    def test_empty_dimension_selection_with_transform(self):
        ...
        with self.assertRaises(ValueError) as context:
            crudatalab.get('IMFWEO2017Apr', country='', subject='LP;NGDP', transform='PCH')
    ...
    def test_wrong_dimension_selection(self):
        ...
        with self.assertRaises(ValueError) as context:
            crudatalab.get('xmhdwqf', company='c1;c2', indicator='ind_a;ind_multi;ind')
    ...
    def test_wrong_dimension_selection_transform(self):
        ...
        with self.assertRaises(ValueError) as context:
            crudatalab.get('xmhdwqf', company='c1;c2', indicator='ind_a;ind_multi;ind', frequency='A', transform='sum')
    ...
    def test_incorrect_dataset_id(self):
        ...
        with self.assertRaises(ValueError) as context:
            crudatalab.get('incorrect_id', somedim='val1;val2')
    ...
    def test_getdata_multiseries_by_member_key(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company='1000000;1000010', indicator='1000020;1000050')
        self.assertEqual(data_frame.shape[0], 56)
        self.assertEqual(data_frame.shape[1], 4)
    ...
    def test_get_data_from_dataset_with_multiword_dimnames_and_metadata_and_mnemomics(self):
        ...
        data_frame, metadata = crudatalab.get('eqohmpb', True, **{'Country': '1000000',
                                                    'Indicator': '1000010'})
    ...
    def test_weekly_frequency(self):
        ...
        data = crudatalab.get('xmhdwqf', company='BOX', indicator='Weekly', frequency='W')
        sname = ('BOX', 'Weekly', 'W')
    ...
    def test_search_by_mnemonics_data(self):
        ...
        data_frame = crudatalab.get('eqohmpb', mnemonics='512NGDP_A_in_test_dataset')
        self.assertEqual(data_frame.shape[1], 1)
    ...
    def test_search_by_mnemonics_with_metadata(self):
        ...
        data_frame, metadata = crudatalab.get('eqohmpb', True, mnemonics='512NGDP_A_in_test_dataset')
        self.assertEqual(data_frame.shape[1], 1)
        sname = ('512NGDP_A_in_test_dataset')
        indx = data_frame.first_valid_index()
        value = data_frame.at[indx, sname]
    ...
    def test_search_by_mnemonics_data_by_all_datasets(self):
        ...
        data_frame = crudatalab.get(mnemonics='512NGDP_A_in_test_dataset;512NGDP')
        self.assertEqual(data_frame.shape[1], 2)
        sname = ('512NGDP_A_in_test_dataset')
        indx = data_frame.first_valid_index()
        value = data_frame.at[indx, sname]
    ...
    def test_search_by_mnemonics_with_metadata_by_all_datasets(self):
        ...
        data_frame, metadata = crudatalab.get(None, True, mnemonics='512NGDP_A_in_test_dataset;512NGDP')
        self.assertEqual(data_frame.shape[1], 2)
        sname = ('512NGDP_A_in_test_dataset')
        indx = data_frame.first_valid_index()
        value = data_frame.at[indx, sname]
    ...
    def test_search_by_mnemonics_with_metadata_by_all_datasets_transform(self):
        """The method is testing searching by mnemonics by all dataset and returns data and metadata"""
        data_frame, metadata = crudatalab.get(None, True, mnemonics='512NGDP_R;512NGDP', transform='PCH', frequency='A')
        self.assertEqual(data_frame.shape[1], 2)
        sname = ('512NGDP_R')
        indx = data_frame.first_valid_index()
        value = data_frame.at[indx, sname]
    ...
    def test_get_all_series_from_dataset(self):
        ...
        data_frame= crudatalab.get('dzlnsee')
        self.assertEqual(data_frame.shape[1], 4)
        self.assertEqual(['Company', 'Indicator', 'Frequency'], data_frame.columns.names)
    ...
    def test_with_empty_attributes_in_the_dimensions(self):
        data, metadata = crudatalab.get('IMFWEO2017Oct', include_metadata=True, country=['914','512'], subject='lp')
    ...
    def test_with_empty_attributes_in_the_dimensions_transform(self):
        data, metadata = crudatalab.get('IMFWEO2017Oct', include_metadata=True, country=['914','512'], subject='lp', frequency='A')
        self.assertEqual(data.shape[0], 43)
        self.assertEqual(data.shape[1], 2)
        self.assertEqual(['Country', 'Subject', 'Frequency'], data.columns.names)
        self.assertEqual(metadata.shape[0], 8)
    ...
    def test_getdata_with_columns(self):
        ...
        data_frame = crudatalab.get('pqgusj', Company = 'APPLE', columns='*', frequency='FQ')
    ...
    def test_getdata_datelabels(self):
        ...
        data_frame = crudatalab.get('pqgusj', company = 'APPLE', frequency='FQ')
    ...
    def test_grouping_functionality(self):
        ...
        generator = crudatalab.get('IMFWEO2017Oct', include_metadata = True, group_by='country', country='Albania;Italy;Japan', subject='ngdp', timerange='2005-2010')
        frames = []
    ...
    def test_FQ_frequescy(self):
        ...
        data_frame = crudatalab.get('xmhdwqf', company='UBER', indicator='Fisqal Quarterly', frequency='FQ')
    ...
    def test_aggregations(self):
        ...
        frame = crudatalab.get('xmhdwqf', company='UBER', indicator='Daily', frequency='D', timerange = '2019M1-2021M4')
        self.assertEqual(frame.shape[0], 366)
        self.assertEqual(frame.shape[1], 1)

        generator = crudatalab.get('xmhdwqf', group_by = 'company', company='UBER', indicator='Daily', frequency='D', timerange = '2019M1-2021M4')
        for frame in generator:
            self.assertEqual(frame.data.shape[0], 366)
            self.assertEqual(frame.data.shape[1], 1)
            

        frame = crudatalab.get('xmhdwqf', company='UBER', indicator='Daily', frequency='Q', timerange = '2019M1-2021M4', transform='sum')
        self.assertEqual(frame.shape[0], 5)
        self.assertEqual(frame.shape[1], 1)

        generator = crudatalab.get('xmhdwqf', group_by='company', company='UBER', indicator='Daily', frequency='Q', timerange = '2019M1-2021M4', transform='sum')
        for frame in generator:
    ...
    def test_auto_aggregations_nodata(self):
        ...
        frame = crudatalab.get('xmhdwqf', company='UBER', indicator='Daily', frequency='D',
                           timerange='2019M1-2021M4')
        self.assertEqual(frame.shape[0], 366)
        self.assertEqual(frame.shape[1], 1)

        frame = crudatalab.get('xmhdwqf', company='UBER', indicator='Daily', frequency='Q',
                           timerange='2019M1-2021M4')
    ...
    def test_auto_disaggregations_nodata(self):
        ...
        frame = crudatalab.get('xmhdwqf', company='UBER', indicator='Annual', frequency='M', timerange='2018-2020')
        self.assertEqual(frame.shape[0], 0)
        self.assertEqual(frame.shape[1], 0)
