"""This is test module for crudatalab client"""
...
class TestKnoemaClient(unittest.TestCase):
    """This is class with crudatalab client unit tests"""
    ...
    def test_too_long_get_query_string(self):
        ...
        for frame in crudatalab.get('US500COMPFINST2017Oct', include_metadata=True, indicator='Total Assets',
    ...
    def test_too_long_data_url(self):
        ...
        separator = ";;"
        frame = crudatalab.get("IMFWEO2021Apr", country="World", separator=separator, subject=separator.join(subject))
        self.assertEqual(frame.shape[1], len(subject))

    def test_ticker_endpoint(self):
        """Testing ticker endpoint"""

        ticker = crudatalab.ticker('DDD')
    ...
    def test_streaming_more_than_1000(self):
        ...
        data_frame = crudatalab.get('nama_r_e3gdp', **{'Measure': 'Euro per inhabitant'})
    ...
    def test_search_wrapper_search_for_timeseries(self):
        ...
        search_results = crudatalab.search('Italy inflation')
        search_results_1 = crudatalab.search('UAE oil production')
    ...
    def test_noaggregation(self):
        data = crudatalab.get(**{"dataset" : "IMFWEO2020Oct", "country": "United States", "subject": "Population (Persons)", "frequency" : "Q" , "transform": 'NOAGG'})
    ...
    def test_include_metadata_true(self):
        ...
        data, metadata = crudatalab.get('IMFWEO2017Apr', True, country=['914', '512'], subject='lp')
    ...
    def test_get_data_with_partial_selection_with_metadata_transform(self):
        ...
        _, metadata = crudatalab.get('IMFWEO2017Apr', True, subject='flibor6', frequency='A')
        self.assertEqual(metadata.shape[1], 2)
        self.assertEqual(['Country', 'Subject', 'Frequency'], metadata.columns.names)
    ...
    def test_get_data_with_partial_selection_with_metadata(self):
        ...
        _, metadata = crudatalab.get('IMFWEO2017Apr', True, subject = 'flibor6')
        self.assertEqual(metadata.shape[1], 2)
        self.assertEqual(['Country', 'Subject', 'Frequency'], metadata.columns.names)
        sname = ('Japan', 'Six-month London interbank offered rate (LIBOR) (Percent)', 'A')
        self.assertEqual(metadata.at['Country Id',sname],'158')
    ...
    def test_get_data_with_partial_selection(self):
        ...
        data_frame = crudatalab.get('IMFWEO2017Apr', subject = 'flibor6')
    ...
    def test_get_data_from_flat_dataset_without_time_and_with_metadata(self):
        ...
        data_frame, metadata = crudatalab.get('pocqwkd', True, **{'Object type': 'Airports',
    ...
    def test_get_data_from_flat_dataset_without_time(self):
        ...
        data_frame = crudatalab.get('pocqwkd', **{'Object type': 'Airports',
                                              'Object name': 'Bakel airport'})
    ...
    def test_get_data_from_flat_dataset_with_multi_measures_and_metadata(self):
        ...
        data_frame, metadata = crudatalab.get('bmlaaaf', True, **{'Country': 'Albania',
    ...
    def test_get_data_from_flat_dataset_with_multi_measures(self):
        ...
        data_frame = crudatalab.get('bmlaaaf', **{'Country': 'Albania',
                                              'Borrower': 'Ministry of Finance',
                                              'Guarantor': 'Albania',
                                              'Loan type': 'B loan',
                                              'Loan status': 'EFFECTIVE',
    ...
    def test_get_data_from_flat_dataset(self):
        ...
        data_frame = crudatalab.get('cblymmf', Country='Albania;Australia', Keyword='FGP;TWP;TRP')
    ...
    def test_get_data_from_dataset_with_multiword_dimnames_and_metadata_transform(self):
        ...
        data_frame, _ = crudatalab.get('FDI_FLOW_CTRY', True, **{'Reporting country': 'AUS',
